...
def encoder(query_sentence, table_names, tokenizer, model):
    ...
    print("highest_matching_table_column_names: ", highest_matching_table_column_names)

    return highest_matching_table_name, highest_matching_table_column_names, highest_matching_table_column_names_copy


def decoder(query_sentence, database_name, highest_matching_table_name, highest_matching_table_column_names, tokenizer_decoder, model_decoder):
...
def sql_executor(sql_query, highest_matching_table_column_names_copy):
    # convert list to lower case
    highest_matching_table_column_names_copy = [
        x.lower() for x in highest_matching_table_column_names_copy]

    # if s3 contains any of the words in lst1 then replace it with double quotes
    for i in highest_matching_table_column_names_copy:
        if i in sql_query:
...
highest_matching_table_name, highest_matching_table_column_names, most_similar_highest_matching_table_column_name, highest_matching_table_column_names_copy = encoder(
    query_sentence, table_names, tokenizer, model)
sql_query = decoder(query_sentence, database_name, highest_matching_table_name,
                    highest_matching_table_column_names, tokenizer_decoder, model_decoder)
sql_executor(sql_query, highest_matching_table_column_names_copy)
